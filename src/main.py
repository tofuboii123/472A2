...
puzzles, goal_states = generatePuzzle(50, 8)
...
gbfs_h2_stats["avg"] = averageStats(gbfs_h2_values)
gbfs_h2_stats["total"] = totalStats(gbfs_h2_values)
writeStatsToCSV(gbfs_h2_name, gbfs_h2_stats["avg"], gbfs_h2_stats["total"])


print("average gbfs2: ", gbfs_h2_stats["avg"])
print("total gbfs2: ", gbfs_h2_stats["total"])
...
astar_h2_stats["avg"] = averageStats(astar_h2_values)
astar_h2_stats["total"] = totalStats(astar_h2_values)
writeStatsToCSV(astar_h2_name, astar_h2_stats["avg"], astar_h2_stats["total"])


print("average astar2: ", astar_h2_stats["avg"])
print("total astar2: ", astar_h2_stats["total"])